...
export default function TechComponentSmall({ name }) {
    ...
    return (
        <div
            className={`bg-white py-1 px-3 flex gap-2 items-center justify-center flex-nowrap rounded-full transition-transform duration-300 group-hover:scale-105 hover:scale-110 shadow-lg shadow-black/50`}>
            <>
